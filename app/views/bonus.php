            ...
            <div class="bonus-hero__inner">
                ...
                <div class="bonus-hero__visual">
                    <div class="bonus-hero-image" aria-hidden="true">
                        <img src="<?= asset_url('img/bonus_groups/s.webp') ?>" alt="Баннер программы лояльности" class="bonus-hero-image__img" width="400" height="240" loading="lazy" onerror="this.style.display='none';var n=this.nextElementSibling;if(n)n.style.display='block';">
                        <div class="bonus-hero-image__fallback" style="display:none;width:100%;height:100%;background:url('<?= asset_url('img/bonus_groups/steel_rods.png') ?>') center/cover no-repeat;"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                ?>
                    <article class="bonus-group-card">
                        <div class="bonus-group-card__image">
                            <?php if ($img): ?>
                                <img src="<?= asset_url('img/bonus_groups/' . $img) ?>" alt="<?= e($alt) ?>" width="160" height="96" loading="lazy" class="bonus-group-card__img" onerror="this.style.display='none';var p=this.nextElementSibling;if(p)p.style.display='block';">
                                <div class="bonus-group-card__placeholder" style="display:none" aria-hidden="true"><img src="<?= asset_url('img/bonus_groups/steel_rods.png') ?>" alt="" width="160" height="96" loading="lazy" class="bonus-group-card__placeholder-img"></div>
                            <?php else: ?>
                                <div class="bonus-group-card__placeholder" aria-hidden="true"><img src="<?= asset_url('img/bonus_groups/steel_rods.png') ?>" alt="" width="160" height="96" loading="lazy" class="bonus-group-card__placeholder-img"></div>
                            <?php endif; ?>
                        </div>
