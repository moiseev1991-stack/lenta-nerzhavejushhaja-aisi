...
?>
<section class="product-faq-accordion" aria-labelledby="product-faq-title">
    ...
    <div class="product-faq-accordion__list">
        ...
        <div class="product-faq-accordion__item">
            ...
            <div class="product-faq-accordion__answer" id="faq-answer-<?= $i ?>" aria-labelledby="faq-trigger-<?= $i ?>" <?= $i === 0 ? '' : 'hidden' ?>>
                <p><?= e($item['answer']) ?></p>
            </div>
        </div>
        <?php endforeach; ?>
