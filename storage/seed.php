...
$stmtPage = $pdo->prepare('INSERT OR IGNORE INTO pages (slug, title, content, updated_at) VALUES (?, ?, ?, ?)');
$stmtPage->execute(['bonus', 'Получить бонус', $bonusHtml, $now]);
echo "Страница bonus создана (если отсутствовала)\n";
